    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('basic', 'Basic User'), ('horizon_planner', 'Horizon Planner'), ('venue_manager', 'Venue Manager'), ('admin', 'Admin')], default='basic', help_text='User role determines access permissions', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('requested_role', models.CharField(choices=[('horizon_planner', 'Horizon Planner'), ('venue_manager', 'Venue Manager')], max_length=20)),
